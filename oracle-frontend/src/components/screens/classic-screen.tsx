  ...
  return (
    <>
      ...
      <div className="flex w-full flex-col sm:mt-8 lg:mt-8 lg:flex-row">
        ...
        <div className="mt-5 w-full sm:mt-10 lg:ml-6 lg:mt-0 lg:w-2/3 xl:w-3/4 rtl:mr-6 rtl:lg:ml-0 ">
          <ComparisonChart />
        </div>
      </div>
      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-[calc(100%-288px)] 2xl:w-[calc(100%-320px)] 3xl:w-[calc(100%-358px)] ltr:lg:pr-6 rtl:lg:pl-6">
          <TransactionTable />
        </div>
